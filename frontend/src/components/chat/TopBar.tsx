  ...
  return (
    <header className="flex shrink-0 flex-wrap items-center justify-between gap-4 bg-pine px-4 py-3 md:px-8">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <span className="font-display text-[21px] font-semibold text-white md:text-2xl">DiaCausal</span>
        <span className="rounded-md border-2 border-pine-hairline px-2.5 py-1 text-xs leading-none font-bold tracking-[0.07em] whitespace-nowrap text-white uppercase">
